...
<html lang="en">
  <head>
    ...
    <title>Modifier adresse - NXP Home</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        {
          ?>
            <form method="post" action="nouvelle-adresse_finale.php">

              <div class="form-group">
                <label>Nouvelle adresse</label>
                <input type="text" class="form-control" placeholder="Nouvelle adresse" name="adresse" required="true">
              </div>
              <br>
